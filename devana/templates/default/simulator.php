...
if (isset($data['output']))
{
 ...
 foreach ($data['output']['attacker']['groups'] as $group)
  $attacker['output'].='<div class="cell" style="text-align: center;"><div style="width: 38px;">'.$group['quantity'].'</div></div>';
 ...
 foreach ($data['output']['defender']['groups'] as $group)
  $defender['output'].='<div class="cell" style="text-align: center;"><div style="width: 38px;">'.$group['quantity'].'</div></div>';
