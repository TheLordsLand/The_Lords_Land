...
<?php include 'templates/'.$_SESSION[$shortTitle.'User']['template'].'/header.php'; ?>
 <div class="container">
  <div class="content" style="text-align: left; max-width: 600px;">
   ...
   <div style="border-bottom: 1px solid black; padding-bottom: 5px; padding-top: 5px;"><?php echo $ui['view']; ?>: <a class="link" href="devanapedia.php?action=list&view=technologies&faction=<?php echo $_GET['faction']; ?>"><?php echo $ui['technologies']; ?></a> | <a class="link" href="devanapedia.php?action=list&view=modules&faction=<?php echo $_GET['faction']; ?>"><?php echo $ui['modules']; ?></a> | <a class="link" href="devanapedia.php?action=list&view=components&faction=<?php echo $_GET['faction']; ?>"><?php echo $ui['components']; ?></a> | <a class="link" href="devanapedia.php?action=list&view=units&faction=<?php echo $_GET['faction']; ?>"><?php echo $ui['units']; ?></a></div>
<?php
    ...
    foreach ($game['technologies'][$_GET['faction']] as $tid=>$technology)
    {
     ...
     echo '
      <div style="padding: 5px; border-bottom: 1px solid black; text-align: left;">
       ...
       <div class="cell">
        <div class="row"><div class="cell" style="font-weight: bold;"><a class="link" href="devanapedia.php?action=get&view=technologies&faction='.$_GET['faction'].'&id='.$tid.'">'.$gl['technologies'][$_GET['faction']][$tid]['name'].'</a></div></div>
        <div class="row"><div class="cell">'.$gl['technologies'][$_GET['faction']][$tid]['description'].'</div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['maxTier'].': </div><div class="cell">'.$technology['maxTier'].'</div></div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['duration'].': </div><div class="cell">'.($technology['duration']*$game['users']['speed']['research']).' '.$ui['minutes'].'</div></div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['module'].': </div><div class="cell"><img class="resource" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/modules/'.$_GET['faction'].'/'.$technology['module'].'.png" title="'.$gl['modules'][$_GET['faction']][$technology['module']]['name'].'"></div></div></div>
    ...
    foreach ($game['modules'][$_GET['faction']] as $mid=>$module)
    {
     ...
     echo '
      <div style="padding: 5px; border-bottom: 1px solid black; text-align: left;">
       ...
       <div class="cell">
        <div class="row"><div class="cell" style="font-weight: bold;"><a class="link" href="devanapedia.php?action=get&view=modules&faction='.$_GET['faction'].'&id='.$mid.'">'.$gl['modules'][$_GET['faction']][$mid]['name'].'</a></div></div>
        <div class="row"><div class="cell">'.$gl['modules'][$_GET['faction']][$mid]['description'].'</div></div>
        <div class="row">
         <div class="inline">
    ...
    foreach ($game['components'][$_GET['faction']] as $cid=>$component)
    {
     ...
     echo '
      <div style="padding: 5px; border-bottom: 1px solid black; text-align: left;">
       ...
       <div class="cell">
        <div class="row"><div class="cell" style="font-weight: bold;"><a class="link" href="devanapedia.php?action=get&view=components&faction='.$_GET['faction'].'&id='.$cid.'">'.$gl['components'][$_GET['faction']][$cid]['name'].'</a></div></div>
        <div class="row"><div class="cell">'.$gl['components'][$_GET['faction']][$cid]['description'].'</div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['duration'].': </div><div class="cell">'.($component['duration']*$game['users']['speed']['craft']).' '.$ui['minutes'].'</div></div></div>
        ...
        <div class="row"><div class="inline"><div class="cell">'.$ui['module'].': </div><div class="cell"><img class="resource" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/modules/'.$_GET['faction'].'/'.$component['module'].'.png" title="'.$gl['modules'][$_GET['faction']][$component['module']]['name'].'"></div></div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['cost'].': </div><div class="cell">'.$costData.'</div></div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['requirements'].': </div><div class="cell">'.$requirementsData.'</div></div></div>
       </div>
      </div>
    ...
    foreach ($game['units'][$_GET['faction']] as $uid=>$unit)
    {
     ...
     echo '
      <div style="padding: 5px; border-bottom: 1px solid black; text-align: left;">
       ...
       <div class="cell">
        <div class="row"><div class="cell" style="font-weight: bold;"><a class="link" href="devanapedia.php?action=get&view=units&faction='.$_GET['faction'].'&id='.$uid.'">'.$gl['units'][$_GET['faction']][$uid]['name'].'</a></div></div>
        <div class="row"><div class="cell">'.$gl['units'][$_GET['faction']][$uid]['description'].'</div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['hp'].': '.$unit['hp'].', '.$ui['damage'].': '.$unit['damage'].', '.$ui['armor'].': '.$unit['armor'].'</div></div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['duration'].': </div><div class="cell">'.($unit['duration']*$game['users']['speed']['train']).' '.$ui['minutes'].'</div></div></div>
        ...
        <div class="row"><div class="inline"><div class="cell">'.$ui['module'].': </div><div class="cell"><img class="resource" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/modules/'.$_GET['faction'].'/'.$unit['module'].'.png" title="'.$gl['modules'][$_GET['faction']][$unit['module']]['name'].'"></div></div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['cost'].': </div><div class="cell">'.$costData.'</div></div></div>
        <div class="row"><div class="inline"><div class="cell">'.$ui['requirements'].': </div><div class="cell">'.$requirementsData.'</div></div></div>
       </div>
      </div>
   ...
   case 'technologies':
    ...
    echo '
     <div style="padding: 5px; border-bottom: 1px solid black; text-align: left;">
      <div class="cell"><img style="width: 60px;" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/technologies/'.$_GET['faction'].'/'.$tid.'.png" /></div>
      <div class="cell">
       <div class="row"><div class="cell" style="font-weight: bold;">'.$gl['technologies'][$_GET['faction']][$tid]['name'].'</div></div>
       <div class="row"><div class="cell">'.$gl['technologies'][$_GET['faction']][$tid]['description'].'</div></div>
       <div class="row"><div class="inline"><div class="cell">'.$ui['maxTier'].': </div><div class="cell">'.$technology['maxTier'].'</div></div></div>
       <div class="row"><div class="inline"><div class="cell">'.$ui['duration'].': </div><div class="cell">'.($technology['duration']*$game['users']['speed']['research']).' '.$ui['minutes'].'</div></div></div>
       <div class="row"><div class="inline"><div class="cell">'.$ui['module'].': </div><div class="cell"><img class="resource" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/modules/'.$_GET['faction'].'/'.$technology['module'].'.png" title="'.$gl['modules'][$_GET['faction']][$technology['module']]['name'].'"></div></div></div>
   ...
   case 'modules':
    ...
    echo '
     <div style="padding: 5px; border-bottom: 1px solid black; text-align: left;">
      <div class="cell"><div class="module" style="background-image: url(\'templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/modules/'.$_GET['faction'].'/moduleBackground.jpg\');"><img style="width: 300px;" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/modules/'.$_GET['faction'].'/'.$mid.'.png" /></div></div>
      <div class="cell">
       <div class="row"><div class="cell" style="font-weight: bold;">'.$gl['modules'][$_GET['faction']][$mid]['name'].'</div></div>
       <div class="row"><div class="cell">'.$gl['modules'][$_GET['faction']][$mid]['description'].'</div></div>
       <div class="row">
        <div class="inline">
         <div class="cell">'.$ui['input'].': </div>
   ...
   case 'components':
    ...
    echo '
     <div style="padding: 5px; border-bottom: 1px solid black; text-align: left;">
      <div class="cell"><img style="width: 60px;" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/components/'.$_GET['faction'].'/'.$cid.'.png" /></div>
      <div class="cell">
       <div class="row"><div class="cell" style="font-weight: bold;">'.$gl['components'][$_GET['faction']][$cid]['name'].'</div></div>
       <div class="row"><div class="cell">'.$gl['components'][$_GET['faction']][$cid]['description'].'</div></div>
       <div class="row"><div class="inline"><div class="cell">'.$ui['duration'].': </div><div class="cell">'.($component['duration']*$game['users']['speed']['craft']).' '.$ui['minutes'].'</div></div></div>
       <div class="row"><div class="inline"><div class="cell">'.$ui['storage'].': </div><div class="cell">'.$component['storage'].'</div><div class="cell"><img class="resource" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/resources/'.$component['storageResource'].'.png" title="'.$gl['resources'][$component['storageResource']]['name'].'"></div></div></div>
       <div class="row"><div class="inline"><div class="cell">'.$ui['module'].': </div><div class="cell"><img class="resource" src="templates/'.$_SESSION[$shortTitle.'User']['template'].'/images/modules/'.$_GET['faction'].'/'.$component['module'].'.png" title="'.$gl['modules'][$_GET['faction']][$component['module']]['name'].'"></div></div></div>
